    ...
    <div className="bg-black text-[#e0e0e0] leading-relaxed overflow-x-hidden">
      ...
      <div className="px-4 py-12 md:px-24">
        ...
        >
          ...
          >
            [ 오케스트라 연주 - 3분 ]<br/>
            <span className="text-sm text-[#999] block mt-2">극의 주요 테마들이 신비롭고 웅장한 멜로디로 흘러나온다</span>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("발토")}`} style={getDialogueInlineStyle("발토")}>
            <p className="text-[#f5d576] font-medium mb-2">발토 (감정을 담아, 천천히):</p>
            <p className="text-[#ddd]">&quot;난... 웃어요. 매일매일. 슬픔을 감추려고 웃어요. 엄마가 떠난 그날부터... 눈물 대신 웃음을 배웠죠.&quot;</p>
            <p className="text-[#ddd] mt-4">&quot;하지만 오늘 밤, 저 별을 봤어요. 마치... 엄마가 손짓하는 것 같았어요. &apos;발토야, 이리 와&apos;... 난 따라갈 수밖에 없었어요.&quot;</p>
          </div>
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("카스퍼")}`} style={getDialogueInlineStyle("카스퍼")}>
            <p className="text-[#8ab4f8] font-medium mb-2">카스퍼 (책을 들어 보이며, 냉정하게):</p>
            <p className="text-[#ddd]">&quot;책 속엔 모든 게 있다 했죠. 신? 그건 우화일 뿐이라 했죠. 증명할 수 없는 건 믿지 않아. 그게... 내가 아는 진리였어요.&quot;</p>
            <p className="text-[#ddd] mt-4">(잠시 망설이다가) &quot;하지만 저 별을 보았을 때... 가슴이 말하더군요. &apos;진리는 책이 아닌 곳에도 있다&apos;고. 난... 대답을 찾아 떠나야 해요.&quot;</p>
          </div>
          ...
          <div className="my-6 text-[#999] text-base p-4 bg-[#1a1a1a] rounded italic">
            [밀로가 마임으로 자신의 이야기를 표현한다. 앙상블이 그를 둘러싸며 조용히 말한다.]
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("앙상블")}`} style={getDialogueInlineStyle("앙상블")}>
            <p className="text-[#ee8b60] font-medium mb-2">앙상블 (밀로를 위해, 조용히):</p>
            <p className="text-[#ddd]">&quot;말을 잃어버린 아이... 전쟁이 앗아간 목소리... 아버지의 플룻만이 그의 유일한 친구...&quot;</p>
            <p className="text-[#ddd] mt-4">&quot;하지만 저 별을 보았을 때... 침묵 속에서 노래가 들렸죠. &apos;밀로야, 두려워 마&apos;... 그 별을 따라 가야 해요.&quot;</p>
          </div>
          ...
          <div className="my-6 text-base leading-loose">
            <p className="text-[#d4af37] font-medium mb-2">세 아이 (함께, 결의에 차서):</p>
            <p className="text-[#ddd] italic">&quot;별을 따라서... 별을 따라... 우리는 가야 해요. 무엇이 기다리는지 몰라도... 이 빛이 이끄는 곳으로.&quot;</p>
            <p className="text-[#ddd] italic mt-4">&quot;외로운 발걸음이었지만... 이제는 혼자가 아니에요. 별을 따라서, 함께 가요. 새로운 세상을 향해!&quot;</p>
          </div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("발토")}`} style={getDialogueInlineStyle("발토")}>
            <p className="text-[#f5d576] font-medium mb-2">발토 (조용히):</p>
            <p className="text-[#ddd] italic">&quot;혼자였던 어둠 속에서...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("카스퍼")}`} style={getDialogueInlineStyle("카스퍼")}>
            <p className="text-[#8ab4f8] font-medium mb-2">카스퍼:</p>
            <p className="text-[#ddd] italic">&quot;길을 잃고 헤맸죠...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("앙상블")}`} style={getDialogueInlineStyle("앙상블")}>
            <p className="text-[#ee8b60] font-medium mb-2">앙상블 (밀로를 대신하여):</p>
            <p className="text-[#ddd] italic">&quot;말없이 울던 밤들...&quot;</p>
          </div>

          <div className="my-6 text-base leading-loose">
            <p className="text-[#d4af37] font-medium mb-2">세 아이 (함께, 희망차게):</p>
            <p className="text-[#ddd] italic">&quot;하지만 이제는 혼자가 아니에요. 우리는 함께, 별을 향해. 함께 걷는 이 길 위에서... 우리는 하나가 되어가요.&quot;</p>
          </div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("발토")}`} style={getDialogueInlineStyle("발토")}>
            ...
            <p className="text-[#ddd] italic">&quot;너희의 온기가 느껴져...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("카스퍼")}`} style={getDialogueInlineStyle("카스퍼")}>
            <p className="text-[#8ab4f8] font-medium mb-2">카스퍼:</p>
            <p className="text-[#ddd] italic">&quot;우린 혼자가 아니야...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("앙상블")}`} style={getDialogueInlineStyle("앙상블")}>
            <p className="text-[#ee8b60] font-medium mb-2">앙상블 (밀로를 대신하여):</p>
            <p className="text-[#ddd] italic">&quot;함께니까... 견딜 수 있어...&quot;</p>
          </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <p className="text-xl mb-4">[ Act I 피날레 ]</p>
            <div className="text-[#ddd] space-y-3">
              <p className="font-medium">세 아이 (함께, 강렬하게 폭풍을 향해):</p>
              <p className="italic">&quot;폭풍이 몰아쳐도... 우리는 하나. 우리는 하나! 서로를 감싸 안고... 우리는 이겨낼 거야!&quot;</p>
              <p className="italic mt-4">&quot;어둠이 덮쳐와도... 우리는 하나. 우리는 하나! 함께하는 우리는... 무너지지 않아!&quot;</p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("앙상블")}`} style={getDialogueInlineStyle("앙상블")}>
            <p className="text-[#ee8b60] font-medium mb-2">마을 사람들 (위협적으로, 함께):</p>
            <p className="text-[#ddd] italic">&quot;누구냐, 밤의 방랑자들... 어둠 속을 헤매는 자들... 우리는 믿지 않아. 의심만이 우리를 지킨다!&quot;</p>
          </div>
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("노파")}`} style={getDialogueInlineStyle("노파")}>
            <p className="text-[#c58af9] font-medium mb-2">노파 (감정을 담아, 천천히):</p>
            <p className="text-[#ddd] italic">&quot;오래전... 나도 너희처럼 순수한 마음으로 믿었지. 하지만 세월이 흐르며... 그 빛을 잃어버렸구나.&quot;</p>
            <p className="text-[#ddd] italic mt-4">&quot;이 아이의 눈을 보니... 잊었던 것이 떠올라. 진실은 말이 아닌... 마음에서 나오는 것...&quot;</p>
          </div>
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("앙상블")}`} style={getDialogueInlineStyle("앙상블")}>
            <p className="text-[#ee8b60] font-medium mb-2">마을 사람들 (함께, 축복하듯):</p>
            <p className="text-[#ddd] italic">&quot;가라, 별의 아이들아... 빛을 따라 걸어가라... 우리의 희망을 싣고... 새로운 세상을 향해...&quot;</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("발토")}`} style={getDialogueInlineStyle("발토")}>
            <p className="text-[#f5d576] font-medium mb-2">발토 (깨달음에 차서):</p>
            <p className="text-[#ddd] italic">&quot;폭풍 속 너희의 온기...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("카스퍼")}`} style={getDialogueInlineStyle("카스퍼")}>
            <p className="text-[#8ab4f8] font-medium mb-2">카스퍼:</p>
            <p className="text-[#ddd] italic">&quot;마을에서 받은 믿음...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("밀로")}`} style={getDialogueInlineStyle("밀로")}>
            <p className="text-[#81c995] font-medium mb-2">밀로:</p>
            <p className="text-[#ddd] italic">&quot;이 플룻에 담긴 사랑...&quot;</p>
          </div>

          <div className="my-6 text-base leading-loose">
            <p className="text-[#d4af37] font-medium mb-2">세 아이 (함께, 감동에 차서):</p>
            <p className="text-[#ddd] italic">&quot;우리가 찾던 빛은... 먼 곳에 있지 않았어. 서로를 사랑하는 마음... 그 안에 신이 계셨어.&quot;</p>
            <p className="text-[#ddd] italic mt-4">&quot;우리 안에... 우리 안에... 빛이 있었던 거야. 함께하는 이 순간에... 우리는 이미 도착했어.&quot;</p>
          </div>
        ...
        >
          ...
          <div className={`my-6 text-base leading-loose ${getDialogueClass("발토")}`} style={getDialogueInlineStyle("발토")}>
            <p className="text-[#f5d576] font-medium mb-2">발토 (경이로움에 차서):</p>
            <p className="text-[#ddd] italic">&quot;이렇게 작고 연약한데... 어떻게 이리 따뜻할까요...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("카스퍼")}`} style={getDialogueInlineStyle("카스퍼")}>
            <p className="text-[#8ab4f8] font-medium mb-2">카스퍼 (눈물로):</p>
            <p className="text-[#ddd] italic">&quot;별보다 더 밝은 빛... 온 세상을 비추는 빛...&quot;</p>
          </div>

          <div className={`my-6 text-base leading-loose ${getDialogueClass("밀로")}`} style={getDialogueInlineStyle("밀로")}>
            <p className="text-[#81c995] font-medium mb-2">밀로 (환한 미소로):</p>
            <p className="text-[#ddd] italic">&quot;아름다워요... 정말... 너무나 아름다워요...&quot;</p>
          </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <p className="text-2xl mb-4">[ 그랜드 피날레 ]</p>
            <div className="text-[#ddd] space-y-4">
              <div>
                <p className="font-bold text-lg mb-2">세 아이 (함께, 감동에 차서):</p>
                <p className="italic">&quot;별을 따라 걸었던 길... 외롭고 험난했지만... 우리는 발견했어요. 사랑이 곧 빛이라는 걸.&quot;</p>
              </div>

              <div className="mt-6">
                <p className="font-bold text-lg mb-2">앙상블 (경건하게):</p>
                <p className="italic">&quot;어둠 속을 헤매던 우리에게... 빛이 찾아왔네. 작은 아기의 모습으로... 희망이 태어났네.&quot;</p>
              </div>

              <div className="mt-6">
                <p className="font-bold text-lg mb-2">전체 (웅장하게, 함께):</p>
                <p className="italic">&quot;빛 속으로... 빛 속으로... 우리 모두 걸어가요. 사랑이 이끄는 곳... 그곳이 천국이에요.&quot;</p>
                <p className="italic mt-4">&quot;별을 따라서, 함께 걸어... 우리는 하나가 되었어요. 빛 속으로, 영원히... 이 사랑은 계속될 거예요!&quot;</p>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="my-6 text-base leading-loose text-center">
            <p className="text-[#d4af37] font-medium mb-4 text-xl">[ 커튼콜 ]</p>
            <p className="font-medium mb-2">전체 출연진 (관객을 향해, 따뜻하게):</p>
            <p className="text-[#ddd] italic">&quot;별을 따라서, 우리는 왔어요. 빛을 찾아서, 사랑을 찾아서. 이제 우리는 알아요... 빛은 우리 안에 있었다는 걸.&quot;</p>
            <p className="text-[#ddd] italic mt-4">&quot;성탄의 기쁨을... 여러분과 나누고 싶어요. 별을 따라서... 우리 모두 함께 걸어가요!&quot;</p>
          </div>
          ...
          <div className="space-y-6 text-[#ccc]">
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                <li>배경 음악: 밝고 희망찬 멜로디가 극 전반에 흐름</li>
                <li>Act I 피날레: 파워풀하고 극적인 배경 음악</li>
                <li>&quot;아버지의 플룻&quot;: 서정적인 플룻 독주 (클래식과 민속음악의 융합)</li>
                <li>그랜드 피날레: 장엄한 오케스트라 연주 (교회 음악 + 극음악의 융합)</li>
              </ul>
            </div>
